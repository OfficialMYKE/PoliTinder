...
export default function ModeratorReports() {
  ...
  if (!tableExists) {
    return (
      <div className="p-8">
        <h1 className="mb-6 text-2xl font-bold text-slate-900">Revisar Reportes</h1>
        <div className="rounded-lg border border-slate-200 bg-white p-8 text-center shadow-sm">
          <Flag className="mx-auto h-12 w-12 text-slate-300" />
          <p className="mt-4 text-sm text-slate-500">
            La tabla de reportes no está disponible.
          </p>
          <p className="mt-1 text-xs text-slate-400">
            Solicita al administrador que ejecute la migración correspondiente.
          </p>
        </div>
      </div>
    )
