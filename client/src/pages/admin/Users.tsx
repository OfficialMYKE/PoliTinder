      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="rounded-lg border border-slate-300 py-2 pl-10 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
        <table className="w-full text-left text-sm">
          <thead className="border-b border-slate-200 bg-slate-50">
            <tr>
              <th className="px-6 py-3 font-medium text-slate-600">Usuario</th>
              <th className="px-6 py-3 font-medium text-slate-600">Facultad</th>
              <th className="px-6 py-3 font-medium text-slate-600">Carrera</th>
          ...
          <tbody className="divide-y divide-slate-200">
            {filtered.map((p) => (
              <tr key={p.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-slate-600">{p.career}</td>
                <td className="px-6 py-4">
                  <span
